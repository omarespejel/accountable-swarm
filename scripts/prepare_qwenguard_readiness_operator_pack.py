    ...
    *,
    ...
    return "\n".join(
        [
            ...
            "```",
            "",
            "That phase is safe to run before hardware. It generates the physical,",
            "ECS, and submission packs, runs the no-hardware fixture/degraded traces,",
            "and confirms the current audit remains `NARROW_CLAIM` for missing",
            "operator evidence.",
            "",
