    ...
    *,
    ...
    return "\n".join(
        [
            ...
            "QWENGUARD_ECS_REVIEW_DATE=\"2026-06-29\" \\",
            "QWENGUARD_ECS_TERMINAL_ARTIFACT=\"runs/ecs/ecs-terminal-proof.txt\" \\",
    ...
    *,
    ...
    return "\n".join(
        [
            ...
            "  local terminal_artifact=\"${ECS_TERMINAL_ARTIFACT:-runs/ecs/ecs-terminal-proof.txt}\"",
