...
Do not claim any of the following without checked artifacts:

- Qwen runs onboard.
- Qwen is in the real-time control path.
- Qwen performs validated 3D grounding.
- The system is safe.
...
- The project is competition-winning.
